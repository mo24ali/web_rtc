...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-6xl min-h-screen flex flex-col">
        ...
        <header class="text-center mb-12 pt-4">
            <div class="flex items-center justify-center gap-3 mb-6">
                <div
                    class="w-14 h-14 bg-gradient-to-br from-blue-600 to-purple-600 text-white rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <p class="text-gray-600 text-lg max-w-2xl mx-auto font-normal">
                Professional virtual interview platform with crystal-clear audio and video. Connect seamlessly with
                candidates anywhere.
            </p>
        </header>
        ...
        <main class="flex-1 flex flex-col justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 card-hover flex flex-col">
                    <div
                        class="w-18 h-18 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <form id="hostForm" class="flex-1 flex flex-col">
                        <div class="mb-6">
                            <label for="hostName"
                                class="block text-gray-700 font-medium mb-2 text-sm uppercase tracking-wider">
                                Your Name
                            </label>
                            <div class="relative">
                                <i
                        ...
                        <button type="submit"
                            class="mt-auto flex items-center justify-center gap-3 w-full py-4 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl">
                    ...
                    <!-- Room Info Panel -->
                    <div id="hostRoomInfo"
                        class="mt-8 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border-2 border-dashed border-blue-400 hidden animate-fade-in">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <h4 class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Room ID
                                </h4>
                                <div
                                    class="bg-white px-4 py-3 rounded-lg border border-gray-300 font-mono font-semibold text-blue-700">
                                    <span id="roomId">INV-8X7A-2B9C</span>
                                </div>
                            </div>
                            <div>
                                <h4 class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Host Name
                                </h4>
                        ...
                        <div>
                            <h4 class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-3">Share
                                Interview Link</h4>
                            <div class="flex flex-col sm:flex-row gap-3">
                                <input type="text" id="roomLink"
                                    ...
                                    readonly value="https://interviewpro.com/join/INV-8X7A-2B9C">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 card-hover flex flex-col">
                    <div
                        class="w-18 h-18 bg-gradient-to-br from-cyan-50 to-green-50 rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <form id="joinForm" class="flex-1 flex flex-col">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="relative">
                                <i
                                    class="fas fa-door-closed absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                                <input type="text" id="roomCode"
                                    class="w-full pl-12 pr-4 py-4 border-2 border-gray-300 rounded-xl focus:border-green-500 focus:outline-none input-focus transition-colors"
                                    placeholder="Enter room ID (e.g., INV-8X7A-2B9C)" required>
                            </div>
                        </div>

                        <button type="submit"
                            class="mt-auto flex items-center justify-center gap-3 w-full py-4 px-6 bg-gradient-to-r from-cyan-500 to-green-500 text-white rounded-xl hover:from-cyan-600 hover:to-green-600 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl">
    ...
    <script>
        ...
        document.getElementById('hostForm').addEventListener('submit', function (e) {
            ...
            // Generate random Room ID (Client-side)
            ...
            setTimeout(() => {
                ...
                const roomLink = `${window.location.origin}/participant.php?room=${roomId}`;
                ...
                // Start countdown
                let countdown = 5; // Give them a bit more time to copy
                ...
                const countdownInterval = setInterval(() => {
                    ...
                    if (countdown <= 0) {
                        ...
                        window.location.href = `host.php?room=${roomId}&name=${encodeURIComponent(hostName)}`;
                    }
                }, 1000);
            }, 600);
        });
