...
<head>
    ...
    <title>Interview Room - Participant | CodeMeet</title>
        ...
        <header class="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div
                        class="bg-gradient-to-br from-blue-600 to-purple-600 w-12 h-12 rounded-xl flex items-center justify-center shadow-md">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-4 mt-2">
                            <div class="flex items-center gap-2 bg-blue-50 px-3 py-1.5 rounded-lg">
                                ...
                                <span
                                    class="font-mono font-semibold text-blue-700"><?php echo htmlspecialchars($room_id); ?></span>
                            </div>
                            <div class="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-lg">
                                <i class="fas fa-user text-gray-600 text-sm"></i>
                                <span
                                    class="font-medium text-gray-700"><?php echo htmlspecialchars($participant_name); ?></span>
                            </div>
                ...
                <div class="flex flex-wrap gap-3">
                    <button id="toggleVideo"
                        class="flex items-center gap-2 px-5 py-3 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow">
                        <i class="fas fa-video text-gray-700"></i>
                        <span class="font-medium text-gray-700">Video</span>
                        <span id="videoStatus"
                            class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">ON</span>
                    </button>
                    ...
                    <button id="leaveRoom"
                        class="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div class="flex items-center gap-6">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-600">Connection: <span
                                    class="font-medium text-gray-800">Excellent</span></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <i class="fas fa-shield-alt text-blue-500"></i>
                            <span class="text-sm text-gray-600">Call is <span
                                    class="font-medium text-gray-800">encrypted</span></span>
                        </div>
                        <div class="flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-3">
                        <button class="p-2.5 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors"
                            title="Screen Share">
...
function hello() {
        ...
        <main class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                ...
                <div class="relative bg-gray-900 aspect-video">
                    ...
                    <div
                        class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center gap-3 bg-black/50 backdrop-blur-sm px-4 py-2.5 rounded-full">
            ...
            <div class="lg:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div
                        class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 h-full flex flex-col">
                        <div class="p-4 bg-gray-900 flex items-center justify-between">
                            ...
                            <span class="text-xs text-gray-400">Synced with host</span>
                        </div>
                ...
                <div class="lg:col-span-1">
                    <div id="chat-container"
                        class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 h-full flex flex-col min-h-[400px]">
                ...
                <div class="lg:col-span-3 bg-white rounded-2xl shadow-lg border border-gray-200">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <span id="participantCount"
                                    class="bg-gray-100 text-gray-800 text-sm font-medium px-3 py-1 rounded-full">0
                                    online</span>
                            </div>
                            <div class="flex items-center gap-3">
                    ...
                    <div id="otherParticipants"
                        class="p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 min-h-[200px]">
                        <!-- Empty State -->
                        ...
                        <div id="participantTemplate" class="hidden">
                            <div
                                class="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-blue-300 transition-colors">
                                <div class="flex items-start gap-3">
                                    <div class="relative">
                                        <div
                                            class="w-12 h-12 bg-gradient-to-br from-gray-300 to-gray-400 rounded-full flex items-center justify-center">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-2 mt-1">
                                            <span class="text-xs bg-blue-100 text-blue-800 px-2 py-0.5 rounded">Video
                                                ON</span>
                                            <span class="text-xs bg-green-100 text-green-800 px-2 py-0.5 rounded">Audio
                                                ON</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="module">
        import { ParticipantWebRTC } from './js/participant.js';
        import { ChatRoom } from './js/chat.js';

        const roomId = "<?php echo $room_id; ?>";
        const userName = "<?php echo $participant_name; ?>";

        console.log("Initializing Participant application...");

        // Initialize Participant WebRTC/Signaling
        const participant = new ParticipantWebRTC(roomId, userName);
        window.participantRTC = participant;
